...
public interface IQuestionRepository extends JpaRepository<Question, Long> {
    @Query("select q.questionText as questionText, ta.correctAnswer as correctAnswer, q.maxScore as maxScore, q.questionId as questionId, " +
            "q.assignment.title as title, q.assignment.startDate as startDate, q.assignment.assignmentId as assignmentId " +
            "from Question q join TeacherAnswer ta " +
            "on q.questionId = ta.question.questionId " +
            "where q.assignment.assignmentId = :assignmentId and q.assignment.classroom.teacher.user.username = :username")
